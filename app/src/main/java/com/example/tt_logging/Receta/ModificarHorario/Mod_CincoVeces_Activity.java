...
public class Mod_CincoVeces_Activity extends AppCompatActivity {

    // Cinco alarmas

    private Button selehora, selehora1, selehora2, selehora3, selehora4;
    private TextView tvhora, tvhora1,tvhora2, tvhora3, tvhora4;
    ...
    private int minutos, hora, minutos1, hora1, minutos2, hora2, hora3, minutos3, hora4, minutos4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Mod_CincoVeces_Activity.this, Menu_principla_Activity.class);
